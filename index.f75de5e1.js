...
const getSalary = (number)=>+number.children[3].textContent.slice(1).split(",").join("");
const localeCompare = (a, b, index)=>b.children[index].textContent.localeCompare(a.children[index].textContent);
